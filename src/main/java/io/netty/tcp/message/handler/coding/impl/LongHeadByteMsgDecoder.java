...
public class LongHeadByteMsgDecoder extends AbstractFixedLengthHeaderByteMsgDecoder {
	...
	public String toString() {
		return "LongHeadByteMsgDecoder [headLengthType=" + headLengthType + ", headerLengthSize=" + headerLengthSize + ", headerLengthIncluded=" + headerLengthIncluded + ", lengthHeaderIncluded=" + lengthHeaderIncluded + "]";
	}
