...
public class KyroObjectMsgDecoder extends AbstractFixedLengthHeaderByteMsgDecoder {
	...
	public String toString() {
		return "KyroObjectMsgDecoder [headLengthType=" + headLengthType + ", headerLengthSize=" + headerLengthSize + ", headerLengthIncluded=" + headerLengthIncluded + ", lengthHeaderIncluded=" + lengthHeaderIncluded + "]";
	}
