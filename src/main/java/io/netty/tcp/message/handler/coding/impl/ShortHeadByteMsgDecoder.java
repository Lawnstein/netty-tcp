...
public class ShortHeadByteMsgDecoder extends AbstractFixedLengthHeaderByteMsgDecoder {
	...
	public String toString() {
		return "ShortHeadByteMsgDecoder [headLengthType=" + headLengthType + ", headerLengthSize=" + headerLengthSize + ", headerLengthIncluded=" + headerLengthIncluded + ", lengthHeaderIncluded=" + lengthHeaderIncluded + "]";
	}
