 ...
 * @version $Revision:$
 */
public class IntHeadByteMsgDecoder extends AbstractFixedLengthHeaderByteMsgDecoder {
	protected final static Logger logger = LoggerFactory.getLogger(IntHeadByteMsgDecoder.class);

	public IntHeadByteMsgDecoder() {
	...
	@Override
	public IntHeadByteMsgDecoder clone() {
		IntHeadByteMsgDecoder d = new IntHeadByteMsgDecoder();
