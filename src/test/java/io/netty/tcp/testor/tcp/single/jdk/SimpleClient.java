...
import io.netty.tcp.netty.client.TcpClient;
...
public class SimpleClient {
	...
	public static TcpClient createClient() {
		return createClient("127.0.0.1", 8000);
	}
	...
	public static TcpClient createClient(String host, int port) {
		...
		client.setHeadLengthType(HeadLengthType.INT);
		client.setObjectSerializable(new JDKObjectSerializer());
		return client;
	}
