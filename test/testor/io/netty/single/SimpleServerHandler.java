...
public class SimpleServerHandler implements ServiceAppHandler {
	 ...
	 * 
	 * @see
	 * io.netty.tcp.server.ServiceAppHandler#call(java.lang.Object,
	 ...
	 * 
	 * @see
	 * io.netty.tcp.server.ServiceAppHandler#onChannelClosed(io.netty
	 * .channel.Channel)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * io.netty.tcp.server.ServiceAppHandler#exceptionCaught(io.netty
